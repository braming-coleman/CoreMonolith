...
internal sealed class PermissionConfiguration : IEntityTypeConfiguration<Permission>
{
    public void Configure(EntityTypeBuilder<Permission> builder)
    {
        ...
        builder.HasData(
            ...
            new Permission { Id = AccessSeedDataConstants.PermissionId_DownloadClientRead, Key = ApiPermissions.DownloadClientRead, Description = "Read access to [download-client] resource" },
            new Permission { Id = AccessSeedDataConstants.PermissionId_DownloadClientWrite, Key = ApiPermissions.DownloadClientWrite, Description = "Write access to [download-client] resource" });
    }
}